...
cantidad = float(input("Ingrese la cantidad (MXN): "))
print("Convertir a 1.-USD 2.-EUR 3.-THB 4.-JPY 5.-KRW 6.-AUD 7.-PEN 8.-CAD 9.-VES 10.-ARS")
...
match opcion:
    ...
    case _:
        ...
        resultado = None
        moneda = None
print("El cambio a la moneda elegida es de: ", resultado, moneda)    